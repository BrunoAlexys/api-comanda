...
public class MenuController {
    ...
    public ResponseEntity<List<CategoryResponseDTO>> getCategoryByUserId(@PathVariable Long userId) {
    ...
    @PreAuthorize(ApplicationConstants.IS_ADMIN_OR_USER)
    public ResponseEntity<List<MenuResponseDTO>> getMenuByUserID(@PathVariable Long userId, @PathVariable Long categoryId) {
